...
![Github Keys Page](./github-keys.png)
...
[Newer (as of 2026) gogs images ship without OpenSSH](https://github.com/gogs/gogs/tree/v0.14.2/docker-next), instead baking
a simple SSH implementation into the binary for cloning. To mirror, we'll need
to add openssh back.
