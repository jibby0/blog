...
const config: SiteConfig = {
  ...
  socialLinks: {
    github: 'https://github.com/jibby0',
    email: 'blog@jibby.org',
    linkedin: 'https://www.linkedin.com/in/jibby0',
    resume: '/Resume.pdf',
    bluesky: 'https://bsky.app/profile/jibby.bsky.social', 
  ...
  characters: {
    myrtle_left: '/myrtle_left.png',
    myrtle_right: '/myrtle_right.webp',
    duck: '/duck.webp',
    owl: '/owl.webp',
    kitkat_left: '/kitkat_left.png',
    kitkat_right: '/kitkat_right.png',
  },
}
